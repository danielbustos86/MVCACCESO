...
$(document).ready(function () {
    ...
    $('#SelectListApr').on('change', function () {
    ...
    $('#btn_aprobar').click(function (e) {
        ...
        $(seleccionados).each(function () {
            idpersona = idpersona + "/" + $(this).parent().parent()["0"].cells[1].innerText;
           
        });
        
        var json = '{"id":"' + aux_solicitud + '", "idpersona":"' + idpersona + '"}';
...
function ActualizaListado() {
    ...
    var idUsuario = 0;
    var opcion = $("#SelectListApr").val();
    var json = '{"idUsuario":"' + idUsuario + '", "opcion":"' + opcion + '"}';
                    ...
                    success: function (response) {
                        ...
                        if (response.mensaje != "") {
                            ...
                            $('#tabla_persona > tbody > tr > td > button').bind("click", function () {
                                ...
                                var idPersona = $(this).parent().parent()["0"].cells[1].innerText;
